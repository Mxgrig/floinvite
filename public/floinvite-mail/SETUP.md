...
3. **Via MySQL Client**:
   ```bash
   mysql -h localhost -u REDACTED_USER_mail -p 'Mail_pa55w0rd!' REDACTED_USER_mail < schema.sql
   ```
...
```bash
mysql -u REDACTED_USER_mail -p 'Mail_pa55w0rd!' REDACTED_USER_mail -e "SHOW TABLES;"
```
