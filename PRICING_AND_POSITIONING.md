# FloInvite – Pricing, Features & Positioning (Working Document)

## Purpose

This document captures the agreed direction for **FloInvite** so decisions stop looping and execution can begin. It focuses on **small companies, estates, and meeting venues** where accurate visitor records and evacuation accountability are required.
...
* Large enterprises
* Corporate HQs
* Organisations needing badges, kiosks, or QR-code workflows

> FloInvite is intentionally simple. No hardware. No enterprise theatre.

---

## Core Job-to-be-Done

> **Capture who is on site, when, and be able to prove it later.**

Secondary outcomes:

* Know who is present during an evacuation
* Reduce paperwork
* Be inspection- and audit-ready without complexity
