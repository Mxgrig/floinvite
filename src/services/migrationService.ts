...
export class MigrationService {
  ...
  private static normalizeSettings(data: unknown): StoredSettings {
    ...
    return {
      ...
      visitorFontFamily: settings.visitorFontFamily || 'outfit',
      visitorPanelBackground: settings.visitorPanelBackground || '#ffffff',
      visitorTextColor: settings.visitorTextColor || '#111827',
