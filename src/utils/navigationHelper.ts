...
export const PAGE_ROUTES: Record<string, PageRoute> = {
  ...
  construction: { page: 'construction', href: '/construction', label: 'Construction Visitor Management' },
  offices: { page: 'offices', href: '/offices', label: 'Office Visitor Management' },
  healthcare: { page: 'healthcare', href: '/healthcare', label: 'Healthcare Visitor Management' },
  coworking: { page: 'coworking', href: '/coworking', label: 'Coworking Visitor Management' },
