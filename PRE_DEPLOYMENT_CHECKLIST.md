...
- [ ] **Verify current DNS records**
  ...
  # Target status: Should point to REDACTED_HOST (Hostinger)
  ```
...
- [ ] DNS records verified: `nslookup floinvite.com` shows `REDACTED_HOST`
...
| Item | Status | Action |
|------|--------|--------|
| DNS points to REDACTED_HOST | ❌ BLOCKER | Update Cloudflare DNS records |
...
1. **Wait for DNS propagation**: `nslookup floinvite.com` → REDACTED_HOST
2. **Upload files**: `scp -P 65002 -r dist/* REDACTED_USER@REDACTED_HOST:~/public_html/`
...
- [ ] Verify IP: REDACTED_HOST
- [ ] Verify port: 65002
- [ ] Verify username: REDACTED_USER
- [ ] Check password is correct: REDACTED_PASSWORD
